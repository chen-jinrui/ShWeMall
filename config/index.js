...
module.exports = {
    build: {
        ...
        // Gzip off by default as many popular static hosts such as Surge or
        // Netlifyalready gzip all static assets for you.  Before setting to `true`,
    ...
    dev: {
        ...
        proxyTable: {
          '/api': {
            ...
            changeOrigin: true,//本地会虚拟一个服务端接收你的请求并代你发送该请求，这样就不会有跨域问题了，当然这只适用于开发环境。
            pathRewrite: {
              '/api': ''
            }
          }
